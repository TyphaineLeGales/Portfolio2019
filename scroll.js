...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // var end = document.getElementById('info');
   if( -showAbout.clientHeight< top.offsetTop- window.scrollY+200){
      ...
      invisible([type, food, dSpace, dot, contact]);
      ...
      invisible([landing, food, dSpace, dot, contact]);
      ...
      buttons[0].style.color="#113ffa";
       ...
       invisible([landing, type, dSpace, dot, contact]);
      ...
      invisible([landing, type, dot, food, contact]);
      ...
      buttons[3].style.color="#113ffa";
       ...
       invisible([landing, type, dot, food, dSpace]);
